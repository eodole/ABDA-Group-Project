...
cols_to_keep <- c("stcd", "state_code","district","urbanindex","grouping","incumbent_party", "Winning.party","Total.Population", "Percentage.Women", "Median.Household.Income", "Mean.Household.Income", "Median.Age", "Percentage.Retirees..65..", "Percentage.Bachelors.Degree.in.Population.over.25", "Unemployment.Rate..16.and.over.")
...
write.csv(joined_final, "joined_final_with_winner_party2.csv", row.names = FALSE)
