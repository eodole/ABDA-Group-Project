...
\begin{frame}{Motivation for Hierarchical Modelling}
    \begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{plots/Census_Regions_and_Division_of_the_United_States.svg.png} %%placeholder!!!!
...
\begin{frame}{Model 1: Trace Plots}
    \begin{center}
        \begin{figure}
            \includegraphics{plots/model1_cong.png}
...
\begin{frame}{Model 2: Trace Plots}
    \begin{center}
        \begin{figure}
            \includegraphics{plots/model2_convg.png}
...
\begin{frame}{Model 3: Trace Plots}
    \begin{center}
        \begin{figure}
            \includegraphics{plots/model3_convg.png}
            \caption{Trace Plots for Model 2}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{Model 4: Trace Plots}
    \begin{center}
        \begin{figure}
            \includegraphics{plots/model4_convg.png}
            \caption{Trace Plots for Model 2}
        \end{figure}
    \end{center}
\end{frame}
