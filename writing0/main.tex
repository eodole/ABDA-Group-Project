...
\small
\theta_j := & \ \beta_{0,j} + \text{Urban\_Grouping}_{i}*\beta_{1} 
& + \text{Total\_Population}*\beta_{2} + \text{Median \_Income} *\beta_{3} + \text{Med.\_Age}*\beta_{4}
